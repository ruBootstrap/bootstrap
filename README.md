...
- [Скачать последнюю версию](https://github.com/twbs/bootstrap/archive/v5.2.3.zip)
- Клонировать репозиторий: `git clone https://github.com/twbs/bootstrap.git`
- Установить с помощью [npm](https://www.npmjs.com/): `npm install bootstrap@v5.2.3`
- Установить с помощью [yarn](https://yarnpkg.com/): `yarn add bootstrap@v5.2.3`
- Установить с помощью [Composer](https://getcomposer.org/): `composer require twbs/bootstrap:5.2.3`
...
Код и документация защищены авторским правом 2011–2022 [авторов Bootstrap](https://github.com/twbs/bootstrap/graphs/contributors). Код распространяется по [лицензии MIT](https://github.com/twbs/bootstrap/blob/main/LICENSE). Документация распространяется по лицензии [Creative Commons](https://creativecommons.org/licenses/by/3.0/).
