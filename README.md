...
- [Скачать последнюю версию](https://github.com/twbs/bootstrap/archive/v5.3.0.zip)
- Клонировать репозиторий: `git clone https://github.com/twbs/bootstrap.git`
- Установить с помощью [npm](https://www.npmjs.com/): `npm install bootstrap@v5.3.0`
- Установить с помощью [yarn](https://yarnpkg.com/): `yarn add bootstrap@v5.3.0`
- Установить с помощью [Composer](https://getcomposer.org/): `composer require twbs/bootstrap:5.3.0`
