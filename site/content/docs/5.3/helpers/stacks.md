...
{{< callout warning >}}
**Внимание!** Недавно в Safari была добавлена поддержка утилит gap с flexbox, поэтому рассмотрите возможность проверки предполагаемой поддержки браузера. С макетом сетки не должно возникнуть проблем. [Подробнее](https://caniuse.com/flexbox-gap).
{{< /callout >}}
