...
- `.navbar-toggler` для использования с нашим плагином сворачивания и другими поведениями [переключения навигации](#отзывчивое-поведение).
...
- Добавьте необязательный `.navbar-nav-scroll` для установки `max-height` и [прокрутки развернутого содержимого панели навигации](#прокрутка).

Вот пример всех подкомпонентов, включенных в адаптивную навигационную панель со светлой темой, которая автоматически сворачивается в контрольной точке `lg` (большая).
