...
Точно так же вы можете использовать [утилиты flexbox]({{< docsref "/utilities/flex" >}}) и [Bootstrap Icons]({{< param icons_ru >}}) для создания предупреждений с помощью иконок. В зависимости от ваших иконок и содержимого вы можете добавить больше утилит или настраиваемых стилей.
...
Точно так же вы можете использовать [утилиты flexbox]({{< docsref "/utilities/flex" >}}) и [Иконки Bootstrap]({{< param icons_ru >}}) для создания предупреждений с помощью иконок. В зависимости от ваших иконок и содержимого вы можете добавить больше утилит или настраиваемых стилей.
