...
<Example showMarkup={false} code={`
Элемент аббревиатуры <abbr title="Язык разметки гипертекста">HTML</abbr>.
`} />
...
<Example showMarkup={false} code={`
<details>
  <summary>Некоторые подробности</summary>
  <p>Больше информации о подробностях.</p>
</details>

<details open>
  <summary>Еще больше подробностей</summary>
  <p>Вот еще больше подробностей о подробностях.</p>
</details>
`} />
