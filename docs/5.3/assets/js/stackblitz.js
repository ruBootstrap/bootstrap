...
</html>`}function J(e,t){let n=x(e);n.action=w("/run",t),n.target=T(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function h(e){var n;return e!=null&&e.contentWindow?((n=V(e))!=null?n:new E(e)).pending:Promise.reject("Provided element is not an iframe.")}function X(e,t){J(e,t)}function Q(e,t){let n=w(`/edit/${e}`,t),o=T(t);window.open(n,o)}function Y(e,t){let n=w(`/github/${e}`,t),o=T(t);window.open(n,o)}function Z(e,t,n){var i;let o=S(e),r=z(t,n),s=document.createElement("iframe");return v(o,s,n),(i=s.contentDocument)==null||i.write(r),h(s)}function ee(e,t,n){let o=S(e),r=document.createElement("iframe");return r.src=_(`/edit/${t}`,n),v(o,r,n),h(r)}function te(e,t,n){let o=S(e),r=document.createElement("iframe");return r.src=_(`/github/${t}`,n),v(o,r,n),h(r)}var L={connect:h,embedGithubProject:te,embedProject:Z,embedProjectId:ee,openGithubProject:Y,openProject:X,openProjectId:Q};var C="https://cdn.jsdelivr.net/npm/bootstrap@5.3.5/dist/css/bootstrap.min.css",O="5.3";var M="https://cdn.jsdelivr.net/npm/bootstrap@5.3.5/dist/js/bootstrap.bundle.min.js",D=`(() => {
...
<html lang="en">
  <head>
    ...
    <link href="https://getbootstrap.com/docs/${O}/assets/css/docs.css" rel="stylesheet">
